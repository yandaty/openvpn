...
cp /etc/openvpn/server/easy-rsa/pki/issued/* /root/openvpn/
cp /etc/openvpn/server/easy-rsa/pki/ca.crt  /root/openvpn/
cp /etc/openvpn/client/easy-rsa/pki/private/* /root/openvpn/
